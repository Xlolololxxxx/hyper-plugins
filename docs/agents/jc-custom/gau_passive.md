# Agent-08 - gau_passive

## Scope
- Tool ID: `gau_passive`
- Tool Name: `GAU PASSIVE URLS`
- Base Command: `gau`
...
## Deliverables
- New parser module in `local/hyper-target-panel/lib/jc-adapters/` named `gau_passive.js`
- Parser unit tests in `local/hyper-target-panel/__tests__/jc-adapters/gau_passive.test.js`
- 5 baseline fixtures from real tool output under `local/hyper-target-panel/data/jc-baseline/gau_passive/`
