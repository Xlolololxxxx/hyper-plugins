# Agent-04 - nmap_udp_top

## Scope
- Tool ID: `nmap_udp_top`
- Tool Name: `NMAP UDP TOP 100`
- Base Command: `nmap`
...
## Command Template
`nmap -sU --top-ports 100 {target} -oN {log_file}`
...
## Deliverables
- New parser module in `local/hyper-target-panel/lib/jc-adapters/` named `nmap_udp_top.js`
- Parser unit tests in `local/hyper-target-panel/__tests__/jc-adapters/nmap_udp_top.test.js`
- 5 baseline fixtures from real tool output under `local/hyper-target-panel/data/jc-baseline/nmap_udp_top/`
